...
class Myuser(AbstractBaseUser):
    ...
    spouse_name = models.CharField(max_length=20,blank=True)
    ...
    def __str__(self):              # __unicode__ on Python 2
        return self.email
        # return '{} {} {} {} {} {} {}'.format(self.first_name,self.last_name,self.fathers_name,self.gender,self.phone_number,self.spouse_name,self.email)
